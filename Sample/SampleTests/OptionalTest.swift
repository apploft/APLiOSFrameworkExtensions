...
//        let someInt: Int? = 3
//        XCTAssertNotNil(someInt.value(or:))
    }
    
    func testValueOrNilWhenVariableHasValue() {
//        let someInt: Int? = nil
//        XCTAssertNil(someInt.value(or:))
    }
    
    //: MARK: test 'nilIfEmpty'
    func testNilIfEmptyWhenStringIsNil() {
    ...
    func testNilIfEmptyWhenArrayIsNil() {
    ...
    func testNilIfEmptyWhenDictionaryIsNil() {
    ...
    func testNilIfEmptyWhenSetIsNil() {
